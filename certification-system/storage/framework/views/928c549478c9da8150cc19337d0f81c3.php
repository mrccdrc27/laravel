...
<body>
    ...
    <form id="searchForm">
        ...
        <input type="text" id="name" name="name" value="<?php echo e(request('name')); ?>" required>
...
<?php /**PATH C:\Users\Bentulan\source\repos\laravel\certification-system\resources\views/components/searchname.blade.php ENDPATH**/ ?>