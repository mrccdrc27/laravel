...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        // Update sp_certification_insert
        DB::unprepared('
        ALTER PROCEDURE sp_certification_insert
        ...
        BEGIN
            ...
            -- Return the newly generated certificationID (the IDENTITY column value)
            SET @certificationID = SCOPE_IDENTITY()
        END
        ');
        // Update sp_certification_update
        DB::unprepared('
         ALTER PROCEDURE sp_certification_update
        ...
        // Update sp_certification_get_by_id
        DB::unprepared('
        ...
        // Update sp_certification_get_by_name

        // sp_certification_delete remains unchanged
        DB::unprepared('
         ALTER PROCEDURE sp_certification_delete
             @certificationID BIGINT
         AS
         BEGIN
             SET NOCOUNT ON;
    ...
    public function down(): void
    {
        ...
        // Revert sp_certification_update
        DB::unprepared('
        ALTER PROCEDURE sp_certification_update
            @certificationID BIGINT,
            @certificationNumber NVARCHAR(100) = NULL,
        ...
        // Revert sp_certification_get_by_id
        DB::unprepared('
        ALTER PROCEDURE sp_certification_get_by_id
            @certificationID BIGINT
        AS
        ...
        // Revert sp_certification_get_by_name
        DB::unprepared('
        ALTER PROCEDURE sp_certification_get_by_name
